                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-sm-right">
                            <a href="{{ route('add-banner') }}" type="button"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex ">
                                            ...
                                            <button class="d-btn btn-primary  mr-2">
                                                <a href="{{ route('edit-banner', $item->id) }}" class="text-light"
                                                    data-toggle="tooltip" data-placement="top" title=""
                                                    data-original-title="Edit"><i
                                                        class="mdi mdi-pencil font-size-18"></i></a>
                                            </button>
                                            {{-- Delete btn --}}
                                            <form class="" action="{{ route('delete-banner', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Banner Information
                                                    </h5>
                                                                            ...
                                                                            <div class="row">
                                                                                <ul class="notice-list notice-info-list">
                                                                                    ...
                                                                                    <li class="col-md-12">
                                                                                        ...
                                                                                        <span>
                                                                                            <img class="w-100"
                                                                                                src="{{ asset('uploads/banner/' . $item->image) }}"
                                                                                                alt="icareer" /> </span>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
